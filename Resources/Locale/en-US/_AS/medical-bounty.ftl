...
as-medical-bounty-redemption-ui-sell-button = Process Discharge

## Body Status Labels
as-medical-bounty-redemption-body-label-init = Insert patient for evaluation
as-medical-bounty-redemption-body-label-no-items = No patient detected
as-medical-bounty-redemption-body-label-body-present = Patient detected
as-medical-bounty-redemption-body-label-valid-bounty = Patient evaluation complete
...
as-medical-bounty-redemption-redeem-label-valid-bounty-to-station = Station credit: {$amount}
